...
for iln = 1:nline
    hp(iln) = patch(xp{iln}, real(yp{iln}), ptchcol{iln}, 'facealpha', alpha{iln}, 'edgecolor', 'none');
end

for iln = 1:nline
    hl(iln) = line(xl{iln}, real(yl{iln}), 'marker', marker{iln}, 'linestyle', lnsty{iln}, 'color', lncol{iln});
end

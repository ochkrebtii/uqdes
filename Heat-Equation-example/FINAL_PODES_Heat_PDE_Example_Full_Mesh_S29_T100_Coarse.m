function [] = FINAL_PODES_Heat_PDE_Example_Full_Mesh_S29_T100_Coarse()
...
CC_Time  = sparse( RR1d(Time, Time, HP_Time(1), Time(1), Time(end))./HP_Time(2) );
CI_Time  = sparse( RQ1d(Time, Time, HP_Time(1), Time(1), Time(end))./HP_Time(2) );
II_Time  = sparse( QQ1d(Time, Time, HP_Time(1), Time(1), Time(end))./HP_Time(2) );

% Spatial Covariance Functions
HP_Space   = [2, 10*int_step_x]; % squared exponential cov
